...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/p_astro-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/p_astro-feedstock)
...
Once the `conda-forge` channel has been enabled, `p_astro` can be installed with:

```
conda install p_astro
```

It is possible to list all of the versions of `p_astro` available on your platform with:
